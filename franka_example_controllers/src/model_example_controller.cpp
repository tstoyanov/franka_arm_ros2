...
controller_interface::return_type ModelExampleController::update(
  ...
  std::array<double, 49> mass = franka_robot_model_->getMass();
  std::array<double, 7> coriolis = franka_robot_model_->getCoriolis();
  std::array<double, 7> gravity = franka_robot_model_->getGravity();
  std::array<double, 16> pose = franka_robot_model_->getPose(franka::Frame::kJoint4);
